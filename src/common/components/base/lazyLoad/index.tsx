...
const LazyLoad = ({ children }: { children: React.ReactElement }) => {
  ...
  return (
    <ErrorBoundary>
      <Suspense
        fallback={
          <div className="fixed inset-0 flex flex-col items-center justify-center z-50 bg-linear-to-br from-[#e6fdfb] to-[#ffffff]">
            <div className="flex flex-col items-center text-center max-w-[320px] p-5">
              ...
              />
              <h1 className="font-serif text-2xl font-bold text-[#272727] mb-2 tracking-wide">
                Trang Quản Trị
              </h1>

              {timeoutReached ? (
                <div className="flex flex-col items-center">
                  <p className="text-[#272727]/80 text-sm font-medium mb-1">
                    Đang tải lâu bất thường
                  </p>
                  <p className="text-xs text-[#272727]/60 mb-6">
                    Vui lòng đợi trong giây lát...
                  </p>
                </div>
              ) : (
                <p className="text-[#272727]/80 text-sm font-medium mb-6">
                  Đang tải dữ liệu...
                </p>
              )}

              <div className="w-[180px] h-[4px] bg-[#1dbfaf]/15 rounded-full overflow-hidden relative">
                <div
                  className="absolute left-0 top-0 h-full bg-[#1dbfaf] rounded-full"
                  style={{
                    width: "40%",
